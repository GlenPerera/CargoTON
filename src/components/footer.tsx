              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form className="w-full">
                  ...
                  <div className=" p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                    ...
                    <button className="mt-1 w-full bg-[#f7e43b] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0">
                      Subscribe
                    </button>
                  </div>
                </form>
